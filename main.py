...
def main():
    with header:
        ...
        st.markdown(
            """
            Insurance companies can benefit from customer information in business decision makings, such as pricing its service. 
            Having historical data to extract profile information on charges behavior might be useful for that purpose.
            """
        )
        st.markdown("""<img
                        src="https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/advisor/wp-content/uploads/2022/04/how_much_is_health_insurance.jpg"
                        alt="Health Insurance Cost"
                        height="320"
                        width="660"
                        />""", 
    ...
    with predictions:
        ...
        pred_button = input_col.button("Estimate Cost")
        ...
        if pred_button:
            ...
            result_col.info(f"The likely amount of charges associated with this profile is U$ {charges}.")
